...
export default function SlideArrowButton({
  ...
  return (
    <button
      className={`group relative rounded-full border cursor-pointer border-white bg-white p-2  ${className}`}
      {...props}>
      <div
      ...
      <span className="relative left-4 z-10 whitespace-nowrap px-6 font-semibold text-black transition-all duration-200 ease-in-out group-hover:-left-3 group-hover:text-white">
        {text}
      </span>
    </button>
  );
